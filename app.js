...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    "default-src 'self'; font-src 'self'; img-src 'self' https://dl.airtable.com https://res.cloudinary.com https://sswebimages.mo.cloudinary.net; script-src 'self' 'unsafe-inline' https://ajax.googleapis.com https://d3e54v103j8qbb.cloudfront.net 'sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0='; style-src 'self' 'unsafe-inline'; frame-src 'self'",
  );
  next();
});
