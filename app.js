...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    "default-src 'self'; font-src 'self'; img-src 'self' https://dl.airtable.com https://res.cloudinary.com https://sswebimages.mo.cloudinary.net; script-src 'self' 'unsafe-inline' https://region1.google-analytics.com/ https://google.com https://www.gstatic.com https://www.googletagmanager.com https://ajax.googleapis.com https://d3e54v103j8qbb.cloudfront.net; style-src 'self' 'unsafe-inline'; frame-src 'self' https://www.google.com; connect-src 'self' https://region1.google-analytics.com/; script-src-elem 'self' 'unsafe-inline' https://www.google.com https://www.googletagmanager.com https://www.gstatic.com https://ajax.googleapis.com https://d3e54v103j8qbb.cloudfront.net",
  );
